...
@interface BasedProfileViewController : BasedTextInputScrollViewController <UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIActionSheetDelegate>
